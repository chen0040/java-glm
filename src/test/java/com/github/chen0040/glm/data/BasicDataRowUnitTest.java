...
public class BasicDataRowUnitTest {
   ...
   public void test_row_with_inputs(){
      ...
      assertThat(row.getCell("input1")).isEqualTo(1.0);
      assertThat(row.getCell("input2")).isEqualTo(2.0);
      assertThat(row.getCell("input3")).isEqualTo(0.0);

      assertThat(row.toArray()).contains(1.0, 0);
      assertThat(row.toArray()).contains(2.0, 1);
      assertThat(row.toArray()).contains(0.0, 2);
   }
   ...
   public void test_row_set_column_names(){
      ...
      assertThat(row.getCell("input1")).isEqualTo(1.0);
      assertThat(row.getCell("input2")).isEqualTo(2.0);
      assertThat(row.getCell("inputX")).isEqualTo(0.0);
   }
   ...
   public void test_row_set_target_column_names(){
      ...
      assertThat(row.getTargetCell("output1")).isEqualTo(1.0);
      assertThat(row.getTargetCell("output2")).isEqualTo(2.0);
      assertThat(row.getTargetCell("outputX")).isEqualTo(0.0);
   }
   ...
   public void test_row_set_categorical_target_column_names(){
      ...
      assertThat(row.getCategoricalTargetCell("output1")).isEqualTo("Hello");
      assertThat(row.getCategoricalTargetCell("output2")).isEqualTo("World");
      assertThat(row.getCategoricalTargetCell("outputX")).isEqualTo("");
   }
   ...
   public void test_row_with_single_numerical_target(){
      ...
      assertThat(row.getTargetCell("numericalOutput")).isEqualTo(2.0);
      assertThat(row.target()).isEqualTo(2.0);
   }
   ...
   public void test_row_with_two_numerical_outputs(){
      ...
      assertThat(row.getTargetCell("output1")).isEqualTo(2.0);
      assertThat(row.getTargetCell("output2")).isEqualTo(1.0);
      assertThat(row.target()).isEqualTo(2.0);
   }
   ...
   public void test_row_with_single_categorical_target(){
      ...
      assertThat(row.getCategoricalTargetCell("categoricalOutput")).isEqualTo("Hello");
      assertThat(row.categoricalTarget()).isEqualTo("Hello");
   }
   ...
   public void test_makeCopy(){
      ...
      assertThat(row2.getCell("input1")).isEqualTo(1.0);
      assertThat(row2.getCell("input2")).isEqualTo(2.0);
      assertThat(row2.getCell("input3")).isEqualTo(0.0);
      ...
      assertThat(row2.getTargetCell("output1")).isEqualTo(2.0);
      assertThat(row2.getTargetCell("output2")).isEqualTo(1.0);

      assertThat(row2.getCategoricalTargetColumnNames()).contains("output1");
      assertThat(row2.getCategoricalTargetCell("output1")).isEqualTo("Hello");
      assertThat(row2.getCategoricalTargetColumnNames()).contains("output2");
      assertThat(row2.getCategoricalTargetCell("output2")).isEqualTo("World");
